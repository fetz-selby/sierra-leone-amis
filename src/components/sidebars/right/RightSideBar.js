...
class RightSideBar extends Component {
  ...
  onTagCloseHandler = id => {
    //Remove id from list
    const newTags = _.filter(this.state.selectedTagsList, item => {
      return item.id !== id;
    });
    this.setState({
  ...
  renderTags = () =>
    this.state.selectedTagsList.map(tag => (
      <Tag
        ...
        id={tag.id}
        name={tag.name}
        onClose={this.onTagCloseHandler}
      />
    ));
      ...
      <div className="right-sidebar">
        <div className="header-container">
          <button
            ...
            onClick={this.onNewJokeClickedHandler}
          >
            New Joke
          </button>
        </div>
        ...
        <div className="sentence-container">
          ...
          <textarea
            ...
            onChange={this.onSentenceChangedHandler}
          ></textarea>
        </div>
        <div className="clearfix"></div>
        ...
        <div className="clearfix"></div>
        <div className="selected-tags-container">{this.renderTags()}</div>
        <div className="clearfix"></div>
        <div className="action-container">
          <button className="save-btn" onClick={this.onUpdateClickedHandler}>
            {this.state.id ? "update" : "save"}
          </button>
          <div className="delete-btn" onClick={this.onDeleteHandler}>
            delete
          </div>
        </div>
      </div>
